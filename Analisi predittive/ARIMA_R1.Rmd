...
plot(train[,1], 
     col = "blue", lwd=0.5, 
     main = "Fitted Values")
lines(xts(mod1$fitted, order.by = index(train)), col="red", lwd=2.5)
```
...
plot(train[,1], 
     col = "blue", lwd=0.5, 
     main = "Fitted Values")
lines(xts(mod2$fitted, order.by = index(train)), col="red", lwd=2.5)
```
...
df_reg <- df
df_reg$Precipitazioni <- r1$Precipitazioni.mm.
...
plot(train[,1], 
     col = "blue", lwd=0.5, 
     main = "Fitted Values")
lines(xts(mod4$fitted, order.by = index(train)), col="red", lwd=2.5)
```
...
plot(validation_reg[,1], 
     col = "blue", lwd=0.5, 
     ylim = c(min(pred_mod4$lower), max(pred_mod4$upper)), main = "Fitted Value")
...
```{r}
err_plot(validation_reg[,1], xts(pred_mod4$mean, order.by = index(validation_reg)))
```
