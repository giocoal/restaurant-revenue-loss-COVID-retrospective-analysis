...
## SARIMAX CON NUOVI REGRESSORI

```{r}
# Dataset festività 
fest <- read_xlsx("C:\\Users\\marco\\OneDrive\\UNIMIB_DataScience\\99-PROJECTS\\DataScienceLab2022\\Dati aggiuntivi\\fest.xlsx", col_types = NULL)
str(fest)
```
...
# Confronto ***forecasting performance*** **dei modelli**
...
Si sceglie di utilizzare due misure di accuratezza (**MAE e RMSE**) di tipo **scale-dependent** perchè:
...
## Procedura di valutazione con *rolling forecasting origin*
...
xreg <- df[, -1]
e <- tsCV(y = df$vendite_r1, forecastfunction = f_mod1, h=1, xreg=xreg, initial = 60)
