...
e_1 <- tsCV_UCM(my_xts = ss, forecastfunction = f_mod1, h=h, initial = initial, window = window)
#e1 <- tail(e1, n = -initial)
e1 <- e_1$e
e1_percentage <- e_1$e_percentage

e_4 <- tsCV_UCM(my_xts = ss, forecastfunction = f_mod4, h=h, initial = initial, window = window)
e4 <- e_4$e
...
e_5 <- tsCV_UCM(my_xts = ss1, forecastfunction = f_mod5, h=h, initial = initial, window = window)
e5 <- e_5$e
