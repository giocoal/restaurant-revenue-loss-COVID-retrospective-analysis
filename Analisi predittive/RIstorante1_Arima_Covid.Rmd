...
Ei remo, lascio qui questo piccolo script che dovresti runnare per favore quando fai cross-validation, nel momento dopo l'uttilizzo delle funzioni di cross validation e generazione degli errori
