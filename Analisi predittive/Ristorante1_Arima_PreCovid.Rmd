...
h = 42 # 6 settimane
initial = 365 # 3 volte l'orizzonte
window = NULL

# Stima degli errori di previsione con CV

e_1 <- tsCV_ARIMA(y = vendite_r1, forecastfunction = f_mod1, h=h, initial = initial)
...
MAE_mod4 <- colMeans(abs(e3), na.rm = TRUE)
...
MAPE_mod3 <- colMeans(abs(e4_percentage), na.rm = TRUE)
