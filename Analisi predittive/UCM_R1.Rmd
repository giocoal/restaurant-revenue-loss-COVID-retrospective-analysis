...
# Zoom in
plot(1:28, RMSE_mod1, type="l", col=1, xlab="horizon", ylab="RMSE", ylim = c(2500,6000))
lines(1:28, RMSE_mod3, type="l",col=2)
lines(1:28, RMSE_mod4, type="l",col=3)
lines(1:28, RMSE_mod5, type="l",col=4)
legend("topleft",legend=c("1_UCM", "3_UCM", "4_UCM","5_UCM"),col=1:4,lty=1)

# Zoom out
plot(1:28, RMSE_mod1, type="l", col=1, xlab="horizon", ylab="RMSE", ylim = c(0,7000))
lines(1:28, RMSE_mod3, type="l",col=2)
lines(1:28, RMSE_mod4, type="l",col=3)
lines(1:28, RMSE_mod5, type="l",col=4)
#legend("topleft",legend=c("1_UCM", "3_UCM", "4_UCM","5_UCM"),col=1:4,lty=1)
...
plot(1:28, MAE_mod1, type="l", col=1, xlab="horizon", ylab="MAE", ylim = c(0,4000))
lines(1:28, MAE_mod3, type="l",col=2)
lines(1:28, MAE_mod4, type="l",col=3)
lines(1:28, MAE_mod5, type="l",col=4)
legend("topleft",legend=c("1_UCM", "3_UCM", "4_UCM","5_UCM"),col=1:4,lty=1)
```
...
plot(1:28, MAPE_mod1, type="l", col=1, xlab="horizon", ylab="MAPE", ylim = c(0,13000))
lines(1:28, MAPE_mod3, type="l",col=2)
lines(1:28, MAPE_mod4, type="l",col=3)
lines(1:28, MAPE_mod5, type="l",col=4)
legend("topleft",legend=c("1_UCM", "3_UCM", "4_UCM","5_UCM"),col=1:4,lty=1)
```
