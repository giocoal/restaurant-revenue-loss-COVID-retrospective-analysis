...
head(df)
write.zoo(df, file="..\\Dati aggiuntivi\\Dati CV_Arima\\df_123.csv", sep=",") # Serve poi per la CV
```
...
fest <- read_xlsx("..\\Dati aggiuntivi\\fest_precovid.xlsx", col_types = NULL)
...
head(df)
write.zoo(df, file="..\\Dati aggiuntivi\\Dati CV_Arima\\df_4.csv", sep=",") # Serve poi per CV
```
